...
generator.templateChoicer = function (templatesPath) {
    return new Promise(function (resolve, reject) {
        try {
            ...
            templates.map(function (template, index) {
                choices.push({
                    name: `${index}) ${template.name} - ${template.description}`,
                    value: template
                });
            });
            inquirer.prompt([
...
generator.actionChoicer = function (templatesPath) {
    return new Promise(function (resolve, reject) {
        try {
            inquirer.prompt([
                {
                    ...
                    choices: [
                        {
                            name: '1) Build from template',
                            value: 'build-from-template'
                        },
                        {
                            name: '2) Create new template',
...
generator.run = function (workPath) {
    ...
    generator.checkTemplatesPath(templatesPath).then(function (created) {
        ...
        generator.actionChoicer(templatesPath).then(function (actionChoicerAnswers) {
            if (actionChoicerAnswers.action === 'build-from-template') {
                generator.templateChoicer(templatesPath).then(function (templateChoicerAnswers) {
